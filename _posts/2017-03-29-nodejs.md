...
如果你是Boss，秘书告诉你A好了B错了，然后你看回对应怎么处理。到底是哪个**something else...**呢，我都不想看了。问题总会有解决的办法的（我是说编程领域，我可是严谨的程序员），解决方案：（参考了[腾讯全端 AlloyTeam 团队 Blog](http://www.alloyteam.com/2015/04/solve-callback-hell-with-generator/))
